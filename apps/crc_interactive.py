...
class CrcInteractive(BaseParser):
    ...
    def parse_args(self, args=None, namespace=None) -> Namespace:
        ...
        if args.mpi and args.num_nodes < self.min_mpi_nodes:
            ...
            print(f'You requested less nodes than the minimum required on the MPI cluster.\ 
                  You have now been allocated the minimum of {self.min_mpi_nodes} nodes.')
        ...
        if args.mpi and args.num_cores < min_cores:
            ...
            print(f'You requested less cores than the required number on the MPI cluster.\ 
                You have now been allocated {min_cores} cores per node on the {args.partition} partition on the MPI cluster.')
